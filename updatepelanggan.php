<?php
	...
	$pid=$_REQUEST["pid"];
	$result_customer=mysql_query("select * from pelanggan where Pelanggan_ID=$pid");
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<li>
              <a href="baru.php">
                <i class="fa fa-th"></i> <span>Penyelenggaraan Baru</span> <small class="label pull-right bg-green">new</small>
              </a>
            </li>
            ...
            <!-- Left col -->
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class="pull-left header"><i class="fa fa-book"></i> Profil Pelanggan</li>
                </ul>
                ...
                <div class="box-body">
				<form name="pelanggan" id="pelanggan" action="#" method="post" enctype="multipart/form-data">
					<div class="pull-left image">
						<img src="dist/img/<?php echo $row_customer["Pelanggan_Imej"]; ?>" width="300px" height="300px" class="img-circle" alt="User Image" style="padding-right:25px; padding-left:10px;"/>
					</div>
					<div class="form-group">
						&nbsp;
                    </div>
                    <div class="form-group">
						Nama&nbsp;&nbsp;&nbsp;&nbsp;: <input type="text" name="nama" id="nama" style="width:30%;" value="<?php echo $row_customer["Pelanggan_Nama"]; ?>"/>
                    </div>
					<div class="form-group">
						Agensi&nbsp;&nbsp;&nbsp;: <input type="text" name="agensi" id="agensi" style="width:30%;" value="<?php echo $row_customer["Pelanggan_Agensi"]; ?>"/>
                    </div>
					<div class="form-group" >
						Email&nbsp;&nbsp;&nbsp;&nbsp;: <input type="email" name="email" id="email" style="width:30%;" value="<?php echo $row_customer["Pelanggan_Email"]; ?>"/>
                    </div>
					<div class="form-group">
						No. Tel&nbsp;&nbsp;: <input type="text" name="tel" id="tel" value="<?php echo $row_customer["Pelanggan_Tel"]; ?>"/>
                    </div>
				...
				<div class="box-footer clearfix">
					<a href="pelanggan.php?pid=<?php echo $row_customer["Pelanggan_ID"]; ?>" class="btn btn-sm btn-info btn-flat pull-right" style="margin-right:487px;">Batal</a>
					<input type="submit" class="btn btn-sm btn-info btn-flat pull-right" style="margin-right:200px;" value="Kemaskini Butiran" name="submitbtn"/>
                </div>
					<!-- ./CONTENT-->
				</form>
				  </div>
    ...
    <script src='plugins/fastclick/fastclick.min.js'></script>
		...
		<?php
			if(isset($_POST["submitbtn"]))
			{
					...
					$location = "dist/img/pelanggan/" . $sess_id .".". $info['extension'];
					
					if ($_FILES["imej"]["error"] > 0) 
					{echo "Return Code: " . $_FILES["imej"]["error"] . "<br>";}
					else 
					{$imej = "pelanggan/".$sess_id .".". $info['extension'];}
					move_uploaded_file($_FILES["imej"]["tmp_name"],$location);
					
					if(isset($imej))
					{mysql_query("update pelanggan set Pelanggan_Imej='$imej' where Pelanggan_ID='$pid'") or die ('Error updating database: '.mysql_error());}
					mysql_query("update pelanggan set Pelanggan_Nama='$nama',Pelanggan_Agensi='$agensi',Pelanggan_Email='$email',Pelanggan_Tel='$tel' where Pelanggan_ID='$pid'") or die ('Error updating database: '.mysql_error());
					echo '<script language="javascript">';
					echo 'alert("Maklumat pelanggan telah dikemaskini dalam pangkalan data.")';
					echo '</script>';
					header("refresh:0.1; url=pelanggan.php?pid=$pid");
			}
		?>