          ...
          <div class="row">
            <!-- Left col -->
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class="pull-left header"><i class="fa fa-pie-chart"></i> Senarai Pelanggan</li>
                </ul>
              ...
              <div class="box box-info">
                ...
                <div class="box-body">
                  <div class="table-responsive">
					...
					<?php
			$result_customer=mysql_query("select * from pelanggan");
			...
			?>
				<table class="table no-margin">
					...
					<tbody>
					<?php					
					while($row_customer=mysql_fetch_assoc($result_customer))
						{
							?>
							<tr>
								<td>
									<?php
										echo $row_customer["Pelanggan_ID"];
									?>
								</td>
								<td>
									<a href="pelanggan.php?pid=<?php echo $row_customer["Pelanggan_ID"]; ?>">
									<?php
										echo $row_customer["Pelanggan_Nama"];
									?>
									</a>
								</td>
								<td>
									<?php
										echo $row_customer["Pelanggan_Agensi"];
									?>
								</td>
								<td>
									<?php
										echo $row_customer["Pelanggan_Email"];
									?>
								</td>
								<td>
									<?php
										echo $row_customer["Pelanggan_Tel"];
									?>
								</td>
							</tr>
							<?php
			...
			{echo "Tiada pelanggan dalam pangkalan data";}
			?>
				...
				<div class="box-footer clearfix">
					...
					<a href="pelangganbaru.php" class="btn btn-sm btn-info btn-flat pull-right" style="margin-right:200px;">Penambahan Baru</a>
                </div>
              </div><!-- /.box -->
					<!-- ./CONTENT-->
