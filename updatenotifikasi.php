<?php
	...
	$nid=$_REQUEST["nid"];
	$result_notification=mysql_query("select * from notifikasi where Notifikasi_ID='$nid'");
	$row_notification=mysql_fetch_assoc($result_notification);
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Kemaskini Notifikasi</title>
            ...
            <!-- Left col -->
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class="pull-left header"><i class="fa fa-folder"></i> Notifikasi</li>
                </ul>
              ...
              <div class="box box-info">
                ...
                <form action="#" method="post">
					...
					Kepada:
                      <input type="email" class="form-control" name="kepada" placeholder="Kepada" value="<?php echo $row_notification["Notifikasi_Kepada"]; ?>"/>
                    </div>
                    <div class="form-group">
					Subjek:
                      <input type="text" class="form-control" name="subjek" placeholder="Subjek" value="<?php echo $row_notification["Notifikasi_Subjek"]; ?>"/>
                    </div>
                    <div>
					Mesej:
                      <textarea class="textarea" name="mesej" placeholder="Mesej" style="width: 100%; height: 325px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $row_notification["Notifikasi_Mesej"]; ?></textarea>
                    </div>
                </div>
				<div class="box-footer clearfix">
					<a href="senarainotifikasi.php" class="btn btn-sm btn-info btn-flat pull-right" style="margin-right:550px;">Batal</a>
...
<?php
	if(isset($_POST["submitbtn"]))
	{
		...
		$body=$mesej;
		$headers = $row["Penyelenggara_Email"];
		
		mysql_query("insert into notifikasi (Notifikasi_Dari,Notifikasi_Kepada,Notifikasi_Subjek,Notifikasi_Mesej) values ('$headers','$memail','$subject','$body')");
		...
		$mail->Subject = "UPDATE NOTIFIKASI:".$subject;
		$mail->Body = $body;
		...
		if (!$mail->send()) {
			...
			echo 'alert("Notifikasi anda telah berjaya dihantar.")';
			echo '</script>';
				header("refresh:0.1; url=senarainotifikasi.php");
		}
	}
?>