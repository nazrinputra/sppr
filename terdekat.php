	...
	<script type="text/javascript">
		$(document).ready(function() {
		  var calendar = $('#calendar').fullCalendar({
		   ...
		   events:  [
						<?php
							$result_event=mysql_query("select * from penyelenggaraan");
							while($row_event=mysql_fetch_assoc($result_event))
							{
						?>
						{
							title  : '<?php echo "MW";printf('%05d',$row_event["Penyelenggaraan_ID"]);echo " : ".$row_event["Penyelenggaraan_Rujukan"]; ?>',
							start  : '<?php echo $row_event["Penyelenggaraan_Tarikh"]; ?>',
							allDay : true,
						},
						<?php
							}
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Jadual Terdekat</li>
          </ol>
        </section>
            ...
            <!-- Left col -->
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class="pull-left header"><i class="fa fa-calendar"></i> Jadual Terdekat</li>
                </ul>
