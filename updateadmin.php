...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Profil <?php if ($row["Penyelenggara_Admin"]==1){echo "Admin";} else {echo "Penyelenggara";} ?></title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Profil <?php if ($row["Penyelenggara_Admin"]==1){echo "Admin";} else {echo "Penyelenggara";} ?></li>
          </ol>
        </section>
            ...
            <!-- Left col -->
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class="pull-left header"><i class="fa fa-book"></i> Profil <?php if ($row["Penyelenggara_Admin"]==1){echo "Admin";} else {echo "Penyelenggara";} ?></li>
                </ul>
                ...
                <div class="box-body">
				<form name="admin" id="admin" action="#" method="post" enctype="multipart/form-data">
					<div class="pull-left image">
						<img src="dist/img/<?php echo $row["Penyelenggara_Imej"]; ?>" width="300px" height="300px" class="img-circle" alt="User Image" style="padding-right:25px; padding-left:10px;"/>
					</div>
					<div class="form-group">
						&nbsp;
                    </div>
                    <div class="form-group">
						Nama&nbsp;&nbsp;&nbsp;&nbsp;: <input type="text" name="nama" id="nama" style="width:30%;" value="<?php echo $row["Penyelenggara_Nama"]; ?>"/>
                    </div>
					<div class="form-group">
						Unit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type="text" name="unit" id="unit" style="width:30%;" value="<?php echo $row["Penyelenggara_Unit"]; ?>"/>
                    </div>
					<div class="form-group" >
						Email&nbsp;&nbsp;&nbsp;&nbsp;: <input type="email" name="email" id="email" style="width:30%;" value="<?php echo $row["Penyelenggara_Email"]; ?>"/>
                    </div>
					<div class="form-group">
						No. Tel&nbsp;: <input type="text" name="tel" id="tel" style="" value="<?php echo $row["Penyelenggara_Tel"]; ?>"/>
                    </div>
					...
					<div class="box-footer clearfix">
						<a href="admin.php" class="btn btn-sm btn-info btn-flat pull-right" style="margin-right:327px;">Batal</a>
						<input type="submit" class="btn btn-sm btn-info btn-flat pull-right" style="margin-right:280px;" value="Kemaskini Butiran" name="submitbtn"/>
					</div>
				</form>
              </div>
					<!-- ./CONTENT-->
    ...
    <script src='plugins/fastclick/fastclick.min.js'></script>
		...
		<?php
			if(isset($_POST["submitbtn"]))
			{
					...
					if(isset($imej))
					{mysql_query("update penyelenggara set Penyelenggara_Imej='$imej' where Penyelenggara_ID='$sess_id'") or die ('Error updating database: '.mysql_error());}
					mysql_query("update penyelenggara set Penyelenggara_Nama='$nama',Penyelenggara_Unit='$unit',Penyelenggara_Email='$email',Penyelenggara_Tel='$tel' where Penyelenggara_ID='$sess_id'") or die ('Error updating database: '.mysql_error());
					echo '<script language="javascript">';
					echo 'alert("Maklumat anda telah dikemaskini dalam pangkalan data.")';
					echo '</script>';
