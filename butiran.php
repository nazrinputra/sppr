...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Butiran Penyelenggaraan</title>
            ...
            <!-- Left col -->
              <div class="nav-tabs-custom">
				...
				<div style="padding:75px;">
					<div class="box-body">
							<form action="#" method="post" style="align:justify;">
								...
								<div class="form-group">
									Nombor Rujukan <span style="margin-left:43px">: <?php echo $row_maintenance["Penyelenggaraan_Rujukan"]; ?></span>
								</div>
								<div class="form-group">
									Status <span style="margin-left:102px">: <?php echo $row_maintenance["Penyelenggaraan_Status"]; ?></span>
								</div>
								<div class="form-group">
									Tarikh <span style="margin-left:106px">: <?php echo $row_maintenance["Penyelenggaraan_Tarikh"]; ?></span>
								</div>
								<div class="form-group">
									Lokasi <span style="margin-left:103px">: <?php echo $row_maintenance["Penyelenggaraan_Lokasi"]; ?></span>
								</div>
								<div class="form-group">
									Aktiviti <span style="margin-left:99px">: <?php echo $row_maintenance["Penyelenggaraan_Aktiviti"]; ?></span>
								</div>
								<div class="form-group">
									Penyelenggara <span style="margin-left:52px">: <?php echo $row_maintenance["Penyelenggaraan_Penyelenggara"]; ?></span>
								</div>
							</form>
							</div>
				...
				<div class="box-footer clearfix">
					<a href="#"><button onClick="window.print()" class="btn btn-sm btn-info btn-flat pull-right" style="margin-right:550px;">Cetak halaman ini</button></a>
					<a href="updatepenyelenggaraan.php?mid=<?php echo $row_maintenance["Penyelenggaraan_ID"]; ?>" class="btn btn-sm btn-info btn-flat pull-right" style="margin-right:200px;">Kemaskini Butiran</a>
                </div>
					<!-- ./CONTENT-->
