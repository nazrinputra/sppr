          ...
          <div class="row">
            <!-- Left col -->
              <div class="nav-tabs-custom">
                ...
                <div class="box-body">
					<div class="pull-left image">
						<img src="dist/img/<?php if($row_customer["Pelanggan_Imej"]=="") {echo "avatar2.png";} else {echo $row_customer["Pelanggan_Imej"];} ?>" width="300px" height="300px" class="img-circle" alt="User Image" style="padding-right:25px; padding-left:10px;"/>
					</div>
					<div class="form-group">
						&nbsp;
                    </div>
                    <div class="form-group">
						Nama&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $row_customer["Pelanggan_Nama"]; ?>
                    </div>
					<div class="form-group">
						Agensi&nbsp;&nbsp;&nbsp;: <?php echo $row_customer["Pelanggan_Agensi"]; ?>
                    </div>
					<div class="form-group" >
						Email&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $row_customer["Pelanggan_Email"]; ?>
                    </div>
					<div class="form-group">
						No. Tel&nbsp;&nbsp;: <?php echo $row_customer["Pelanggan_Tel"]; ?>
                    </div>
              </div>
				<div class="box-footer clearfix">
					<a href="#"><button onClick="window.print()" class="btn btn-sm btn-info btn-flat pull-right" style="margin-right:420px;">Cetak halaman ini</button></a>
					<a href="updatepelanggan.php?pid=<?php echo $row_customer["Pelanggan_ID"]; ?>" class="btn btn-sm btn-info btn-flat pull-right" style="margin-right:200px;">Kemaskini Butiran</a>
                </div>
					<!-- ./CONTENT-->
