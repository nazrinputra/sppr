<?php
	...
	$result_search=mysql_query("select * from penyelenggaraan where Penyelenggaraan_Aktiviti like '%$query%'");
?>
<!DOCTYPE html>
<html>
  <head>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            <!-- Left col -->
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class="pull-left header"><i class="fa fa-inbox"></i> Carian</li>
                </ul>
					...
					while($row_search=mysql_fetch_assoc($result_search))
						{
							...
							<tr>
								<td>
									<a href="notifikasi.php?nid=<?php echo $row_search["Penyelenggaraan_ID"]; ?>">
										<?php echo "MW";printf('%05d',$row_search["Penyelenggaraan_ID"]); ?>
									</a>
								</td>
								<td>
									<a href="butiran.php?mid=<?php echo $row_search["Penyelenggaraan_ID"]; ?>">
									<?php
										echo $row_search["Penyelenggaraan_Rujukan"];
									?>
									</a>
								</td>
								<td>
									<?php
										echo $row_search["Penyelenggaraan_Tarikh"];
									?>
								</td>
								<td>
									<?php
										echo $row_search["Penyelenggaraan_Lokasi"];
									?>
								</td>
								<td>
									<?php
										echo $row_search["Penyelenggaraan_Aktiviti"];
									?>
								</td>
								<td>
									<?php
										echo $row_search["Penyelenggaraan_Status"];
									?>
								</td>
								<td>
									<?php
										echo $row_search["Penyelenggaraan_Penyelenggara"];
									?>
								</td>
							</tr>
							<?php
			...
			{echo "Tiada penyelenggaraan ditemui";}
			?>
					<!-- ./CONTENT-->
