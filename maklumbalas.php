          ...
          <div class="row">
			...
			<!-- quick email widget -->
              <div class="box box-info">
				...
				<?php if ($row["Penyelenggara_Admin"]==1)
				{
					$result_feedback=mysql_query("select * from maklumbalas");
					if(mysql_num_rows($result_feedback))
					{
						while($row_feedback=mysql_fetch_assoc($result_feedback))
						{
				?>
							<div class="info-box bg-red">
								<span class="info-box-icon"><i class="ion-ios-chatbubble-outline"></i></span>
								<div class="info-box-content">
								  <span class="info-box-text">Maklumbalas dari <?php echo $row_feedback['Maklumbalas_Dari']; ?> <a href="replymaklumbalas.php?rid=<?php echo $row_feedback['Maklumbalas_ID']; ?>"><button style="color:white;" class="btn btn-sm btn-info btn-flat pull-right">Balas</button></a></span>
				...
				?>
                  <form action="#" method="post">
                    ...
                    <div>
					Mesej:
                      <textarea class="textarea" placeholder="Mesej" name="mesej" style="width: 100%; height: 325px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                    </div>
...
<?php
	if(isset($_POST["submitbtn"]))
	{
		...
		$body="Maklumbalas dari Sistem Pengurusan Penyelenggaraan Rangkaian (SPPR): ".$mesej;
		...
		$mail->addAddress('hajar@gitn.com.my');
		...
		if (!$mail->send()) {
			...
			mysql_query("insert into maklumbalas (Maklumbalas_Dari,Maklumbalas_Subjek,Maklumbalas_Mesej) values ('$headers','$subject','$body')");
			echo '<script language="javascript">';
			echo 'alert("Maklumbalas anda telah berjaya dihantar kepada admin.")';
			echo '</script>';
