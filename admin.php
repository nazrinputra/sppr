            ...
            <!-- Left col -->
              <div class="nav-tabs-custom">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
						Nama&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $row["Penyelenggara_Nama"]; ?>
                    </div>
					<div class="form-group">
						Unit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $row["Penyelenggara_Unit"]; ?>
                    </div>
					<div class="form-group" >
						Email&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $row["Penyelenggara_Email"]; ?>
                    </div>
					<div class="form-group">
						No. Tel&nbsp;: <?php echo $row["Penyelenggara_Tel"]; ?>
                    </div>
					<div class="box-footer clearfix">
						<a href="#"><button onClick="window.print()" class="btn btn-sm btn-info btn-flat pull-right" style="margin-right:320px;">Cetak halaman ini</button></a>
						<a href="updateadmin.php" class="btn btn-sm btn-info btn-flat pull-right" style="margin-right:200px;">Kemaskini Butiran</a>
					</div>
              </div>
					<!-- ./CONTENT-->
