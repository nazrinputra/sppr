    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li class="active"><a href="index.php"><i class="fa fa-dashboard"></i> Utama</a></li>
          </ol>
        </section>
          ...
          <div class="row">
            <!-- Left col -->
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class="pull-left header"><i class="fa fa-inbox"></i> Menu Utama</li>
                </ul>
                <div class="tab-content no-padding">
                  <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 580px;">
			...
			<div style="padding:25px;">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Senarai Penyelenggaraan</span>
                  <span class="info-box-number"><?php echo $count_maintenance['total']; ?> aktiviti penyelenggaraan dijadualkan</span>
                  <div class="progress">
                    <div class="progress-bar" style="width: <?php echo $count_maintenance['total'];?>%"></div>
                  </div>
                  <span class="progress-description">
                    <?php echo $count_maintenance['total']; ?>% penyelenggaraan ditunda
                  </span>
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Senarai pelangggan dalam sistem</span>
                  <span class="info-box-number"><?php echo $count_customer['total']; ?> pelanggan telah didaftarkan</span>
                  <div class="progress">
                    <div class="progress-bar" style="width: <?php echo $count_customer['total']; ?>%"></div>
                  </div>
                  <span class="progress-description">
                    <?php echo $count_customer['total']; ?>% pelanggan telah menerima notifikasi
                  </span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Notifikasi Sistem</span>
                  <span class="info-box-number"><?php echo $count_notification['total']; ?></span>
                  <div class="progress">
                    <div class="progress-bar" style="width: <?php echo $count_notification['total']; ?>%"></div>
                  </div>
                  <span class="progress-description">
                    <?php echo $count_notification['total']; ?>% Selesai dilaksanakan
                  </span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
