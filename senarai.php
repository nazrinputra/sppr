...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Senarai Penyelenggaraan</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Senarai Penyelenggaraan</li>
          </ol>
        </section>
          ...
          <div class="row">
            <!-- Left col -->
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class="pull-left header"><i class="fa fa-files-o"></i> Senarai Penyelenggaraan</li>
                </ul>
              ...
              <div class="box box-info">
                ...
                <div class="box-body">
                  <div class="table-responsive">
					...
					<?php
			$result_maintenance=mysql_query("select * from penyelenggaraan");
			if(mysql_num_rows($result_maintenance))
			{
			?>
				<table class="table no-margin">
					<thead>
					...
					<tbody>
					<?php					
					while($row_maintenance=mysql_fetch_assoc($result_maintenance))
						{
							?>
							<tr>
								<td>
									<a href="notifikasi.php?nid=<?php echo $row_maintenance["Penyelenggaraan_ID"]; ?>">
										<?php echo "MW";printf('%05d',$row_maintenance["Penyelenggaraan_ID"]); ?>
									</a>
								</td>
								<td>
									<a href="butiran.php?mid=<?php echo $row_maintenance["Penyelenggaraan_ID"]; ?>">
									<?php
										echo $row_maintenance["Penyelenggaraan_Rujukan"];
									?>
									</a>
								</td>
								<td>
									<?php
										echo $row_maintenance["Penyelenggaraan_Tarikh"];
									?>
								</td>
								<td>
									<?php
										echo $row_maintenance["Penyelenggaraan_Lokasi"];
									?>
								</td>
								<td>
									<?php
										echo $row_maintenance["Penyelenggaraan_Aktiviti"];
									?>
								</td>
								<td>
									<?php
										echo $row_maintenance["Penyelenggaraan_Status"];
									?>
								</td>
								<td>
									<?php
										echo $row_maintenance["Penyelenggaraan_Penyelenggara"];
									?>
								</td>
							</tr>
							<?php
			...
			?>
                ...
                <div class="box-footer clearfix">
					...
					<a href="baru.php" class="btn btn-sm btn-info btn-flat pull-right" style="margin-right:200px;float:left;">Penyelenggaraan Baru</a>
                </div>
              </div><!-- /.box -->
					<!-- ./CONTENT-->
