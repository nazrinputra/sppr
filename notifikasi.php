<?php
	...
	{
		$nid=$_REQUEST["nid"];
		$result_maintenance=mysql_query("select * from penyelenggaraan where Penyelenggaraan_ID='$nid'");
            ...
            <!-- Left col -->
              ...
              <div class="box box-info">
                ...
                <form action="#" method="post">
					...
					Kepada:
                      <input type="email" class="form-control" name="kepada" placeholder="Kepada"/>
                    </div>
                    <div class="form-group">
					Subjek:
                      <input type="text" class="form-control" name="subjek" placeholder="Subjek" <?php if(isset($nid)){echo "value=".$row_maintenance["Penyelenggaraan_Rujukan"];} ?>></input>
                    </div>
                    <div>
					Mesej:
                      <textarea class="textarea" name="mesej" placeholder="Mesej" style="width: 100%; height: 325px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php if(isset($nid)){echo $row_maintenance["Penyelenggaraan_Aktiviti"];} ?></textarea>
                    </div>
                </div>
                <div class="box-footer clearfix">
                  <input type="submit" class="btn btn-sm btn-info btn-flat pull-right" name="submitbtn" style="margin-right:550px;" value="Hantar" />
                </div>
				</form>
              </div>
			 </div>
...
<?php
	if(isset($_POST["submitbtn"]))
	{
		...
		$body="Notifikasi dari Sistem Pengurusan Penyelenggaraan Rangkaian (SPPR): ".$mesej;
