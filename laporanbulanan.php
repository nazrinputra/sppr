          ...
          <div class="row">
            <!-- Left col -->
              <div class="nav-tabs-custom">
				...
				<?php
					...
					if($month==12)
						$bulan="Disember";
				?>
                  <li class="pull-left header"><i class="fa fa-book"></i> Laporan Bulanan SPPR untuk Bulan <?php echo $bulan." ".$year; ?></li>
                </ul>
              ...
              <div class="box box-info">
                ...
                <?php 
					echo "<p style='text-align: center'>Jumlah penyelenggaraan bagi bulan ".$bulan." ".$year." adalah: <span style='font-size:120%'><b>".$count."</b></span></p>"; 
					...
					echo "<p style='text-align: center'>Peratus bagi bulan ".$bulan." ".$year." daripada keseluruhan aktiviti adalah: <span style='font-size:120%'><b>".number_format((float)$percent, 2, '.', '')."%</b></span></p>";
				?>
              </div><!-- /.box -->
