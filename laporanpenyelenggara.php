      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Senarai Pelanggan</li>
          </ol>
        </section>
          ...
          <div class="row">
            <!-- Left col -->
              <div class="nav-tabs-custom">
				...
				<?php
					$penyelenggara=$_REQUEST["name"];
				?>
                  <li class="pull-left header"><i class="fa fa-book"></i> Laporan Penyelenggaraan oleh <?php echo $penyelenggara; ?></li>
                </ul>
              ...
              <div class="box box-info">
				...
				<table class="table no-margin">
					...
					<?php
						...
						$count=0;
						while($row_report=mysql_fetch_assoc($result_report))
						{
							?>
							<tr>
								<td>
									<a href="butiran.php?mid=<?php echo $row_report["Penyelenggaraan_ID"]; ?>">
									<?php
										echo $row_report["Penyelenggaraan_Rujukan"];
									?>
									</a>
								</td>
								<td>
									<?php
										echo $row_report["Penyelenggaraan_Tarikh"];
									?>
								</td>
								<td>
									<?php
										echo $row_report["Penyelenggaraan_Aktiviti"];
									?>
								</td>
								<td>
									<?php
										echo $row_report["Penyelenggaraan_Lokasi"];
									?>
								</td>
								<td>
									<?php
										echo $row_report["Penyelenggaraan_Penyelenggara"];
									?>
								</td>
							</tr>
							<?php
                ...
                <?php 
					echo "<p style='text-align: center'>Jumlah penyelenggaraan oleh ".$penyelenggara." adalah: <span style='font-size:120%'><b>".$count."</b></span></p>"; 
					echo "<p style='text-align: center'>Jumlah kesemua aktiviti penyelenggaraan dalam sistem adalah: <span style='font-size:120%'><b>".$count_maintenance['total']."</b></span></p>";
					$percent=$count/$count_maintenance['total']*100;
					echo "<p style='text-align: center'>Peratus bagi penyelenggaraan ".$penyelenggara." daripada keseluruhan aktiviti adalah: <span style='font-size:120%'><b>".number_format((float)$percent, 2, '.', '')."%</b></span></p>";
				?>
              </div><!-- /.box -->
			  
			    <div class="box-footer clearfix">
					<a href="#"><button onClick="window.print()" class="btn btn-sm btn-info btn-flat pull-right" style="margin-right:500px;">Cetak halaman ini</button></a>
                </div>
